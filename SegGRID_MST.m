function [SegRAW, SegGRID] = SegGRID_MST(imgRgb,dispar,focal,basel,x0,sx,PosHeight,GroundPlane, p2 )       

% ============== Parameters for Space Grid Segmentation(coarse) via MST ============================        
    DepthShrink_Para         = p2.DepthShrink_Para;
    stepZ                    = p2.stepZ;
    stepX                    = p2.stepX;
    height_histdim           = p2.height_histdim;
    color_histdim            = p2.color_histdim;
    MinSize                  = p2.MinSize;
    RegionNum                = p2.RegionNum;
    BaseNum                  = p2.BaseNum;
% =========================================================================    
